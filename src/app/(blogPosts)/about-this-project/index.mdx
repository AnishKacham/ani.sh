...
- #### Blog
  ...
  Some other things I plan for it are, tags, Search by title, summary or tags. Maybe even a preview image.
...
- #### Spotiy status
  ...
  but hey the recommendation algorithm is still pretty solid. Also the model seems to be well trained for me with well over a year's worth of listening data which I won't have
  in case I shift to YT Music or something else.
  ...
  I'd love to ship this equalizer version of spotify status as an npm package so one could use it on their github readme also.
  For another day as I've never published an npm package before🫠.
